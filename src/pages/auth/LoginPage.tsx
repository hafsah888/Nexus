...
export const LoginPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Instead of navigating immediately, require OTP verification
      setStep('otp');
      setIsLoading(false);
    } catch (err) {
        ...
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          {step === 'credentials' ? (
            ...
            <>
              ...
              <div className="bg-accent-50 border border-accent-200 text-accent-700 text-sm rounded-md px-4 py-2 mb-4 text-center">
